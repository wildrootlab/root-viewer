...
from .guiAutoscrollbar import AutoScrollbar

MAX_IMAGE_PIXELS = 1500000000  # maximum pixels in the image
...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.__filter = Image.BICUBIC  # could be: NEAREST, BILINEAR, BICUBIC and ANTIALIAS
        ...
        if self.imwidth * self.imheight > self.__huge_size * self.__huge_size and \
                        self.__image.tile[0][0] == 'raw':  # type: ignore | only raw images can be tiled
    ...
    def smaller(self):
        """ Resize HUGE images proportionally and return smaller image """
